...
export function createScratchInstance(Scratch) {
    ...
    return {
        ...
        canGeolocate: Scratch.canGeolocate || (() => vm.securityManager.canGeolocate()),
        canNotify: Scratch.canNotify || (() => vm.securityManager.canNotify()),
        canOpenWindow: Scratch.canOpenWindow || createCanOpenWindow(vm),
        canReadClipboard: Scratch.canReadClipboard || (() => vm.securityManager.canReadClipboard()),
        canRecordAudio: Scratch.canRecordAudio || (() => vm.securityManager.canRecordAudio()),
        canRecordVideo: Scratch.canRecordVideo || (() => vm.securityManager.canRecordVideo()),

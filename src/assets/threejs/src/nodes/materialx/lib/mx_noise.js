...
export const mx_select = /*@__PURE__*/ Fn(
...
export const mx_bilerp_0 = /*@__PURE__*/ Fn(
	([
		v0_immutable,
		v1_immutable,
		v2_immutable,
...
export const mx_bilerp_1 = /*@__PURE__*/ Fn(
	([
		v0_immutable,
		v1_immutable,
		v2_immutable,
...
export const mx_trilerp_0 = /*@__PURE__*/ Fn(
	([
		v0_immutable,
		v1_immutable,
		v2_immutable,
		...
		return r1
			.mul(
				t1.mul(v0.mul(s1).add(v1.mul(s))).add(t.mul(v2.mul(s1).add(v3.mul(s))))
			)
			.add(
				r.mul(
					t1
						.mul(v4.mul(s1).add(v5.mul(s)))
						.add(t.mul(v6.mul(s1).add(v7.mul(s))))
				)
			)
	}
).setLayout({
...
export const mx_trilerp_1 = /*@__PURE__*/ Fn(
	([
		v0_immutable,
		v1_immutable,
		v2_immutable,
...
export const mx_trilerp = /*@__PURE__*/ overloadingFn([
	mx_trilerp_0,
	mx_trilerp_1
])

export const mx_gradient_float_0 = /*@__PURE__*/ Fn(
	([hash_immutable, x_immutable, y_immutable]) => {
		...
		return mx_negate_if(u, bool(h.bitAnd(uint(1)))).add(
			mx_negate_if(v, bool(h.bitAnd(uint(2))))
		)
	}
).setLayout({
...
export const mx_gradient_float_1 = /*@__PURE__*/ Fn(
	([hash_immutable, x_immutable, y_immutable, z_immutable]) => {
		...
		const v = float(
			mx_select(
				h.lessThan(uint(4)),
				y,
				mx_select(h.equal(uint(12)).or(h.equal(uint(14))), x, z)
			)
		).toVar()
...
export const mx_gradient_float = /*@__PURE__*/ overloadingFn([
	mx_gradient_float_0,
	mx_gradient_float_1
])

export const mx_gradient_vec3_0 = /*@__PURE__*/ Fn(
	([hash_immutable, x_immutable, y_immutable]) => {
		const y = float(y_immutable).toVar()
		const x = float(x_immutable).toVar()
...
export const mx_gradient_vec3_1 = /*@__PURE__*/ Fn(
	([hash_immutable, x_immutable, y_immutable, z_immutable]) => {
		const z = float(z_immutable).toVar()
		const y = float(y_immutable).toVar()
		const x = float(x_immutable).toVar()
...
export const mx_gradient_vec3 = /*@__PURE__*/ overloadingFn([
	mx_gradient_vec3_0,
	mx_gradient_vec3_1
])
...
export const mx_gradient_scale2d = /*@__PURE__*/ overloadingFn([
...
export const mx_gradient_scale3d = /*@__PURE__*/ overloadingFn([
...
export const mx_bjfinal = /*@__PURE__*/ Fn(
...
export const mx_hash_int_2 = /*@__PURE__*/ Fn(
...
export const mx_hash_int_3 = /*@__PURE__*/ Fn(
...
export const mx_hash_int_4 = /*@__PURE__*/ Fn(
...
export const mx_hash_int = /*@__PURE__*/ overloadingFn([
	mx_hash_int_0,
	mx_hash_int_1,
	mx_hash_int_2,
	mx_hash_int_3,
...
export const mx_hash_vec3_1 = /*@__PURE__*/ Fn(
	([x_immutable, y_immutable, z_immutable]) => {
		const z = int(z_immutable).toVar()
		const y = int(y_immutable).toVar()
		const x = int(x_immutable).toVar()
...
export const mx_hash_vec3 = /*@__PURE__*/ overloadingFn([
	mx_hash_vec3_0,
	mx_hash_vec3_1
])
...
export const mx_perlin_noise_float_0 = /*@__PURE__*/ Fn(([p_immutable]) => {
	...
	const result = float(
		mx_bilerp(
			...
			mx_gradient_float(mx_hash_int(X.add(int(1)), Y), fx.sub(1.0), fy),
			mx_gradient_float(mx_hash_int(X, Y.add(int(1))), fx, fy.sub(1.0)),
			mx_gradient_float(
...
export const mx_perlin_noise_float_1 = /*@__PURE__*/ Fn(([p_immutable]) => {
	...
	const result = float(
		mx_trilerp(
			...
			mx_gradient_float(mx_hash_int(X.add(int(1)), Y, Z), fx.sub(1.0), fy, fz),
			mx_gradient_float(mx_hash_int(X, Y.add(int(1)), Z), fx, fy.sub(1.0), fz),
			mx_gradient_float(
			...
			mx_gradient_float(mx_hash_int(X, Y, Z.add(int(1))), fx, fy, fz.sub(1.0)),
			mx_gradient_float(
...
export const mx_perlin_noise_float = /*@__PURE__*/ overloadingFn([
...
export const mx_perlin_noise_vec3_0 = /*@__PURE__*/ Fn(([p_immutable]) => {
	...
	const result = vec3(
		mx_bilerp(
			...
			mx_gradient_vec3(mx_hash_vec3(X.add(int(1)), Y), fx.sub(1.0), fy),
			mx_gradient_vec3(mx_hash_vec3(X, Y.add(int(1))), fx, fy.sub(1.0)),
			mx_gradient_vec3(
...
export const mx_perlin_noise_vec3_1 = /*@__PURE__*/ Fn(([p_immutable]) => {
	...
	const result = vec3(
		mx_trilerp(
			...
			mx_gradient_vec3(mx_hash_vec3(X.add(int(1)), Y, Z), fx.sub(1.0), fy, fz),
			mx_gradient_vec3(mx_hash_vec3(X, Y.add(int(1)), Z), fx, fy.sub(1.0), fz),
			mx_gradient_vec3(
			...
			mx_gradient_vec3(mx_hash_vec3(X, Y, Z.add(int(1))), fx, fy, fz.sub(1.0)),
			mx_gradient_vec3(
...
export const mx_perlin_noise_vec3 = /*@__PURE__*/ overloadingFn([
...
export const mx_cell_noise_float = /*@__PURE__*/ overloadingFn([
...
export const mx_cell_noise_vec3 = /*@__PURE__*/ overloadingFn([
...
export const mx_fractal_noise_float = /*@__PURE__*/ Fn(
	([
		p_immutable,
		octaves_immutable,
...
export const mx_fractal_noise_vec3 = /*@__PURE__*/ Fn(
	([
		p_immutable,
		octaves_immutable,
		lacunarity_immutable,
...
export const mx_fractal_noise_vec2 = /*@__PURE__*/ Fn(
	([
		p_immutable,
		octaves_immutable,
		lacunarity_immutable,
...
export const mx_fractal_noise_vec4 = /*@__PURE__*/ Fn(
	([
		p_immutable,
		octaves_immutable,
		lacunarity_immutable,
		...
		const p = vec3(p_immutable).toVar()
		const c = vec3(
			mx_fractal_noise_vec3(p, octaves, lacunarity, diminish)
		).toVar()
		const f = float(
			mx_fractal_noise_float(
				p.add(vec3(int(19), int(193), int(17))),
...
export const mx_worley_distance_0 = /*@__PURE__*/ Fn(
	([
		p_immutable,
		x_immutable,
		y_immutable,
...
export const mx_worley_distance_1 = /*@__PURE__*/ Fn(
	([
		p_immutable,
		x_immutable,
		y_immutable,
...
export const mx_worley_distance = /*@__PURE__*/ overloadingFn([
	mx_worley_distance_0,
	mx_worley_distance_1
])

export const mx_worley_noise_float_0 = /*@__PURE__*/ Fn(
...
export const mx_worley_noise_vec2_0 = /*@__PURE__*/ Fn(
	([p_immutable, jitter_immutable, metric_immutable]) => {
		const metric = int(metric_immutable).toVar()
		const jitter = float(jitter_immutable).toVar()
		const p = vec2(p_immutable).toVar()
...
export const mx_worley_noise_vec3_0 = /*@__PURE__*/ Fn(
	([p_immutable, jitter_immutable, metric_immutable]) => {
		const metric = int(metric_immutable).toVar()
		const jitter = float(jitter_immutable).toVar()
		const p = vec2(p_immutable).toVar()
...
export const mx_worley_noise_float_1 = /*@__PURE__*/ Fn(
	([p_immutable, jitter_immutable, metric_immutable]) => {
		const metric = int(metric_immutable).toVar()
		const jitter = float(jitter_immutable).toVar()
		const p = vec3(p_immutable).toVar()
...
export const mx_worley_noise_float = /*@__PURE__*/ overloadingFn([
	mx_worley_noise_float_0,
	mx_worley_noise_float_1
])

export const mx_worley_noise_vec2_1 = /*@__PURE__*/ Fn(
	([p_immutable, jitter_immutable, metric_immutable]) => {
		const metric = int(metric_immutable).toVar()
		const jitter = float(jitter_immutable).toVar()
		const p = vec3(p_immutable).toVar()
...
export const mx_worley_noise_vec2 = /*@__PURE__*/ overloadingFn([
	mx_worley_noise_vec2_0,
	mx_worley_noise_vec2_1
])

export const mx_worley_noise_vec3_1 = /*@__PURE__*/ Fn(
	([p_immutable, jitter_immutable, metric_immutable]) => {
		const metric = int(metric_immutable).toVar()
		const jitter = float(jitter_immutable).toVar()
		const p = vec3(p_immutable).toVar()
...
export const mx_worley_noise_vec3 = /*@__PURE__*/ overloadingFn([

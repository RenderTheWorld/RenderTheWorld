...
export const tangentLocal =
	/*@__PURE__*/ tangentGeometry.xyz.toVar('tangentLocal')
 ...
 * @type {Node<vec3>}
 */
export const tangentView = /*@__PURE__*/ modelViewMatrix
 ...
 * @type {Node<vec3>}
 */
export const tangentWorld = /*@__PURE__*/ tangentView
 ...
 * @type {Node<vec3>}
 */
export const transformedTangentView = /*@__PURE__*/ tangentView.toVar(
 ...
 * @type {Node<vec3>}
 */
export const transformedTangentWorld = /*@__PURE__*/ transformedTangentView
	.transformDirection(cameraViewMatrix)
	.normalize()

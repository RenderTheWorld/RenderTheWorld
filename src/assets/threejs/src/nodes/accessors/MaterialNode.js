...
class MaterialNode extends Node {
	...
	setup(builder) {
		...
		if (scope === MaterialNode.COLOR) {
			const colorNode =
				material.color !== undefined ? this.getColor(scope) : vec3()
 ...
 * @type {Node<float>}
 */
export const materialAlphaTest = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<vec3>}
 */
export const materialColor = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
	MaterialNode.COLOR
)
 ...
 * @type {Node<float>}
 */
export const materialShininess = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<vec3>}
 */
export const materialEmissive = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialOpacity = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<vec3>}
 */
export const materialSpecular = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialSpecularIntensity = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<vec3>}
 */
export const materialSpecularColor = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialSpecularStrength = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialReflectivity = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialRoughness = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialMetalness = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<vec3>}
 */
export const materialNormal = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
	MaterialNode.NORMAL
)
 ...
 * @type {Node<float>}
 */
export const materialClearcoat = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialClearcoatRoughness = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<vec3>}
 */
export const materialClearcoatNormal = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialRotation = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<vec3>}
 */
export const materialSheen = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
	MaterialNode.SHEEN
)
 ...
 * @type {Node<float>}
 */
export const materialSheenRoughness = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<vec2>}
 */
export const materialAnisotropy = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialIridescence = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialIridescenceIOR = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialIridescenceThickness = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialTransmission = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialThickness = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialIOR = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
	MaterialNode.IOR
)
 ...
 * @type {Node<float>}
 */
export const materialAttenuationDistance = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<vec3>}
 */
export const materialAttenuationColor = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialLineScale = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialLineDashSize = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialLineGapSize = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialLineWidth = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialLineDashOffset = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialPointSize = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialDispersion = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<vec3>}
 */
export const materialLightMap = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
 ...
 * @type {Node<float>}
 */
export const materialAO = /*@__PURE__*/ nodeImmutable(
	MaterialNode,
	MaterialNode.AO
)

 ...
 * @type {Node<vec3>}
 */
export const reflectView = /*@__PURE__*/ positionViewDirection
	.negate()
 ...
 * @type {Node<vec3>}
 */
export const refractView = /*@__PURE__*/ positionViewDirection
	.negate()
	.refract(transformedNormalView, materialRefractionRatio)
 ...
 * @type {Node<vec3>}
 */
export const reflectVector = /*@__PURE__*/ reflectView
 ...
 * @type {Node<vec3>}
 */
export const refractVector = /*@__PURE__*/ refractView
	.transformDirection(cameraViewMatrix)
	.toVar('reflectVector')

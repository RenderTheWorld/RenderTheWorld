 ...
 */
export const positionWorld = /*@__PURE__*/ modelWorldMatrix
	.mul(positionLocal)
	.xyz.toVarying('v_positionWorld')
	.context({ needsPositionReassign: true })
 ...
 * @type {Node<vec3>}
 */
export const positionWorldDirection = /*@__PURE__*/ positionLocal
 ...
 * @type {VaryingNode<vec3>}
 */
export const positionViewDirection = /*@__PURE__*/ positionView
	.negate()

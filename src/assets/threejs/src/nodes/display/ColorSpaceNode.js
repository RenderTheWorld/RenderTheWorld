 ...
 * @returns {ColorSpaceNode}
 */
export const workingToColorSpace = (node, colorSpace) =>
	nodeObject(
 ...
 * @returns {ColorSpaceNode}
 */
export const colorSpaceToWorking = (node, colorSpace) =>
	nodeObject(
		new ColorSpaceNode(nodeObject(node), colorSpace, WORKING_COLOR_SPACE)
	)

...
class ToneMappingNode extends TempNode {
	...
	setup(builder) {
		...
		const toneMappingFn =
			builder.renderer.library.getToneMappingFunction(toneMapping)
 ...
 */
export const toneMappingExposure = /*@__PURE__*/ rendererReference(
	'toneMappingExposure',
	'float'
)

addMethodChaining('toneMapping', (color, mapping, exposure) =>
	toneMapping(mapping, exposure, color)
)

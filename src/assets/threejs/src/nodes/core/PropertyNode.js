 ...
 */
export const diffuseColor = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'vec4',
	'DiffuseColor'
)
 ...
 */
export const emissive = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'vec3',
	'EmissiveColor'
)
 ...
 */
export const roughness = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'float',
	'Roughness'
)
 ...
 * @type {PropertyNode<float>}
 */
export const metalness = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'float',
	'Metalness'
)
 ...
 * @type {PropertyNode<float>}
 */
export const clearcoat = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'float',
	'Clearcoat'
)
 ...
 * @type {PropertyNode<float>}
 */
export const clearcoatRoughness = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'float',
	'ClearcoatRoughness'
)
 ...
 * @type {PropertyNode<float>}
 */
export const sheenRoughness = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'float',
	'SheenRoughness'
)
 ...
 * @type {PropertyNode<float>}
 */
export const iridescence = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'float',
	'Iridescence'
)
 ...
 * @type {PropertyNode<float>}
 */
export const iridescenceIOR = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'float',
	'IridescenceIOR'
)
 ...
 * @type {PropertyNode<float>}
 */
export const iridescenceThickness = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'float',
 ...
 * @type {PropertyNode<float>}
 */
export const alphaT = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'float',
	'AlphaT'
)
 ...
 * @type {PropertyNode<float>}
 */
export const anisotropy = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'float',
	'Anisotropy'
)
 ...
 * @type {PropertyNode<vec3>}
 */
export const anisotropyT = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'vec3',
	'AnisotropyT'
)
 ...
 * @type {PropertyNode<vec3>}
 */
export const anisotropyB = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'vec3',
	'AnisotropyB'
)
 ...
 */
export const specularColor = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'color',
	'SpecularColor'
)
 ...
 * @type {PropertyNode<float>}
 */
export const specularF90 = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'float',
	'SpecularF90'
)
 ...
 * @type {PropertyNode<float>}
 */
export const shininess = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'float',
	'Shininess'
)
 ...
 * @type {PropertyNode<vec4>}
 */
export const output = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'vec4',
	'Output'
)
 ...
 * @type {PropertyNode<float>}
 */
export const dashSize = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'float',
	'dashSize'
)
 ...
 * @type {PropertyNode<float>}
 */
export const gapSize = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'float',
	'gapSize'
)
 ...
 * @type {PropertyNode<float>}
 */
export const pointWidth = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'float',
	'pointWidth'
)
 ...
 * @type {PropertyNode<float>}
 */
export const transmission = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'float',
	'Transmission'
)
 ...
 * @type {PropertyNode<float>}
 */
export const thickness = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'float',
	'Thickness'
)
 ...
 * @type {PropertyNode<float>}
 */
export const attenuationDistance = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'float',
	'AttenuationDistance'
)
 ...
 * @type {PropertyNode<color>}
 */
export const attenuationColor = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'color',
	'AttenuationColor'
)
 ...
 * @type {PropertyNode<float>}
 */
export const dispersion = /*@__PURE__*/ nodeImmutable(
	PropertyNode,
	'float',
	'Dispersion'
)

...
class WebGPUTextureUtils {
	...
	createTexture(texture, options = {}) {
		...
		const format =
			...
			options.format ||
			getFormat(texture, backend.device)
	...
	updateTexture(texture, options) {
		...
		if (
			...
			textureDescriptorGPU === undefined /* unsupported texture format */
		)
			return
	...
	_getDefaultVideoFrame() {
		...
		if (defaultVideoFrame === null) {
			...
			this.defaultVideoFrame = defaultVideoFrame = new VideoFrame(

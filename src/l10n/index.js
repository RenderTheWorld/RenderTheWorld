...
export default {
    "zh-cn": {
        ...
        "RenderTheWorld.init":
            "初始化并设置背景颜色为 [color] 大小 [sizex] x [sizey] y [ed] 抗锯齿",
        ...
        "RenderTheWorld.getChildrenNumInObject.tooltip": "获得某个物体中的子物体数量（不包含子物体的子物体数量，子物体可能也有子物体），如果没有这个物体返回-1",
        "RenderTheWorld.getChildrenInObject.tooltip": "获得某个物体中的第几个子物体，如果没有这个子物体返回一个空字符串（\"\"）",
    ...
    en: {
        ...
        "RenderTheWorld.init":
            "init and set the background color to [color] size: [sizex] x [sizey] y [ed] anti aliasing",
        ...
        "RenderTheWorld.getChildrenNumInObject": "Get the number of sub objects in Object: [name]",
        "RenderTheWorld.getChildrenInObject": "Get the [nun] th sub object in Object [name]",
        ...
        "RenderTheWorld.getObjectPos.tooltip": "Get the position of any xyz axis of the object",
        "RenderTheWorld.getObjectRotation.tooltip":
        ...
        "RenderTheWorld.getChildrenNumInObject.tooltip": "Get the number of sub objects in an object (excluding sub objects, which may also have sub objects). If there are no such objects, return -1",
        "RenderTheWorld.getChildrenInObject.tooltip": "Get one of the sub objects in a Object, and if there is no the sub object, return an empty string (\"\")",
